...
<SCRIPT language=javascript>
	...
	function deleteCus(id){
		if(confirm("您确定要删除该联系人吗？")){
			window.location.href="${pageContext.request.contextPath}/LinkManAction_delete?lkm_id="+id;
		}
	}
</SCRIPT>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>
									<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/LinkManAction_list"
											method=post>
										<!-- 隐藏域.当前页码 -->
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=textbox id="lkm_name"
														style="WIDTH: 80px" maxLength=50 name="lkm_name" value="${lkm_name }">
														
													</TD>
													<TD>所属客户名称asdfasdf：</TD>
													<TD>
														<input type="hidden" id="cust_id" name="customer.cust_id" value="${param['customer.cust_id'] }">
														<input type="text" id="cust_name" name="cust_name" value="${param['cust_name'] }"/>
														<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list','','width=680,height=400')">
													</TD>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													&nbsp;&nbsp;
													<a href="javascript:void(0);" onclick="deleteCus(<s:property value='#linkman.lkm_id'/>)">删除</a>
													</TD>
												</TR>
												</s:iterator>
												<%-- </c:forEach> --%>
