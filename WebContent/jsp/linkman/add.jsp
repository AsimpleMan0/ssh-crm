...
<html>
<head>
<TITLE><s:property value="#linkMan!=null?'编辑':'添加'"/>联系人</TITLE> 
				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#linkMan!=null?'编辑':'添加'"/>联系人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								...
								<td colspan="3">
									...
									<input type="text" id="cust_name" style="WIDTH: 180px" value="<s:property value="#linkMan.customer.cust_name"/>"/>
									<input type="button" value="选择" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_list?select=true','','width=680,height=400')
">
								</td>
							</tr>
							<TR>
