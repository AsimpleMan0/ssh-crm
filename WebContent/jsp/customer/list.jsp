...
<SCRIPT language=javascript>
	...
	function deleteCus(id){
		if(confirm("您确定要删除该公司吗？")){
			window.location.href="${pageContext.request.contextPath}/CustomerAction_delete?cust_id="+id;
		}
	}
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>
										<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/CustomerAction_list"
											method=post>
										<!-- 隐藏域.当前页码 -->
										...
										<!-- 隐藏域.是否选择的标识-->
										<input type="hidden" name="selected"  value="<s:property value='#parameters.select' />"/>
											...
											<TBODY>
												...
												<TR
													...
													<s:if test="#parameters.select==null">
														...
														&nbsp;&nbsp;
														<a href="javascript:void(0);" onclick="deleteCus(<s:property value='#customer.cust_id'/>)">删除</a>
													</s:if>
													<s:else>
