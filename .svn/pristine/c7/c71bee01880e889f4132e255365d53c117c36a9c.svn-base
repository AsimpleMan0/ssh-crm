...
<SCRIPT language=javascript>
	...
	//删除用户
	function deleteVisit(d){
		alert(d);
		if(confirm("您确定要删除该联系人吗？")){
			//window.location.href="${pageContext.request.contextPath}/SaleVisitAction_delete?visit_id="+id;
		}
	}
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE borderColor=#cccccc cellSpacing=0 cellPadding=0
							...
							<TBODY>
								<TR>
									<TD height=25>	
										<FORM id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/SaleVisitAction_list"
											method=post>
										<!-- 隐藏域.当前页码 -->
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/SaleVisitAction_edit?visit_id=<s:property value="visit_id" />">修改</a>
														&nbsp;&nbsp;
														<a href="javascript:void(0);" onclick="deleteVisit("<s:property value=""/>")">删除</a>
													</TD>
												</TR>
												</s:iterator>
